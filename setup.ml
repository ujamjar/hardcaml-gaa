...
(* OASIS_START *)
(* DO NOT EDIT (digest: 53f1c2c19172bee65d3ee94f1cfcc14d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/hardcaml-gaa";
          synopsis = "Guarded Atomic Actions for HardCaml";
          description =
            Some [OASISText.Para "Guarded Atomic Actions for HardCaml"];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Prims"; "Graph_ex"; "Mrl"; "Frl"; "Frl_hw"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "hardcaml-gaa";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/hardcaml-gaa.git";
                      src_repo_browser =
                        Some "https://github.com/ujamjar/hardcaml-gaa";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\202f\159\218\132\146\165\174\219 ]\206\135k\225Z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
